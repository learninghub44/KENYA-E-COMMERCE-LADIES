...
export default function SalePage() {
  ...
  useEffect(() => {
    fetch("/api/storefront/products/sale")
      .then((r) => r.json())
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-muted-foreground">Great deals on products you love</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="py-20 text-center">
          <p className="text-lg text-muted-foreground">No sale items available right now.</p>
