...
export default function NewArrivalsPage() {
  ...
  useEffect(() => {
    fetch("/api/storefront/products/new-arrivals")
      .then((r) => r.json())
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-muted-foreground">Fresh styles just landed</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="py-20 text-center">
          <p className="text-lg text-muted-foreground">No new arrivals yet.</p>
